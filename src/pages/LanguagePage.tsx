...
import {
  androidSetup,
  androidQuickstart,
  androidDoTransaction,
  androidTestPrint,
  androidErrorHandling,
  androidListener,
      ...
      <main className="flex-1 min-w-0 px-8 lg:px-10 py-10 max-w-3xl">
        ...
        {config.isPreview && (
          ...
          >
            ...
            <p style={{ color: "#c84801" }}>
              <strong>v1 status: Preview.</strong> The API surface is locked but
              the SDK artifact ships in Phase 7. Do not use in production until
              GA.
            </p>
          </div>
        )}
        ...
        <div className="mb-6">
          <LanguageTabs
            ...
            onTabChange={(t) => {
              setActiveTab(t);
              setActiveExample("doTransaction");
            }}
          />
        </div>
        ...
        {activeTab !== "examples" ? (
          ...
          <div>
            ...
            <CodeBlock
              ...
              filename={`${activeExample}.${
                config.codeLanguage === "kotlin"
                  ? "kt"
                  : config.codeLanguage === "swift"
                  ? "swift"
                  : config.codeLanguage === "typescript"
                  ? "ts"
                  : config.codeLanguage
              }`}
            />
