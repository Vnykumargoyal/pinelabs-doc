...
const platforms = [
  {
    name: "Android (Kotlin)",
    status: "Shipping",
    path: "/docs/languages/android",
    icon: "🤖",
  },
  {
    name: "iOS (Swift)",
    status: "Preview",
    path: "/docs/languages/ios",
    icon: "🍎",
  },
  {
    name: "Python",
    status: "Preview",
    path: "/docs/languages/python",
    icon: "🐍",
  },
  {
    name: "Node.js (TS)",
    status: "Preview",
    path: "/docs/languages/nodejs",
    icon: "⬡",
  },
...
const quickLinks = [
  {
    ...
    desc: "App-to-App transport, AAR setup",
    path: "/docs/languages/android",
    color: "#eef3ff",
  },
  {
    title: "Lifecycle & Threading",
    desc: "SDK construction, callbacks",
    path: "/docs/concepts/lifecycle",
    color: "#eef3ff",
  },
  {
    title: "Transports",
    desc: "App-to-App, Cloud, PADController",
    path: "/docs/concepts/transports",
    color: "#eef3ff",
  },
  {
    title: "Error Handling",
    desc: "SdkError taxonomy, retry strategy",
    ...
    <div className="flex max-w-6xl mr-auto px-0 relative">
      ...
      <main className="flex-1 min-w-0 px-8 lg:px-10 py-10">
        ...
        <div className="mb-10 pb-10 border-b border-stripe-border">
          <div
            className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full text-xs font-semibold mb-4"
          ...
          <p className="text-lg text-stripe-muted leading-relaxed max-w-2xl mb-6">
            A single, language-idiomatic library for driving Pine Labs payment
            terminals from your POS, restaurant, retail, or unattended-checkout
            software. Built in Rust, wrapped with UniFFI for every supported
            platform.
          </p>
                ...
                <li key={link.path}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-stripe-subtle mt-0.5">
                        {link.desc}
                      </p>
                    </div>
                  </Link>
